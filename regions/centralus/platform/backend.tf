...
# Example creation:
#   az group create --name m3i-hub-prod-rg-tf-cus --location centralus
#   az storage account create --name m3ihubprodstortfcus --resource-group m3i-hub-prod-rg-tf-cus --location centralus --sku Standard_LRS
